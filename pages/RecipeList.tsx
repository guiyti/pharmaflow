...
import { StatusBadge, SearchInput, Modal } from '../components/ui';
import { NewRecipeForm } from '../components/NewRecipeForm';
import { RecipeStatus, Recipe } from '../types';
    ...
    <div className="flex flex-col p-6 lg:p-10">
      <div className="mb-8 flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
        ...
        <button
          ...
          className="flex items-center justify-center gap-2 rounded-lg bg-primary-600 px-4 py-2.5 text-sm font-bold text-white shadow-sm hover:bg-primary-700 transition-colors active:scale-95"
        >
          <Plus size={18} />
          Nova Receita
        </button>
